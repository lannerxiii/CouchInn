      ...
      <main class="container col-sm-12 col-sm-offset-0">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 align="center"style="font-size: 170%;">¡Solicitudes aceptadas!</h3>
          </div>
          <div>
            <body>
              <br>
          ...
          <div class="panel-body">
            Ingresa dos fechas para ver la solicitudes que se aceptaron
          </br></br>
          <div class="control-group">
            <div class="controls col-md-offset-1">
              <form class="form-horizontal" name="formu_tarjeta" method="POST" action="reporte_solicitudes.php">
        ...
        <main class="container col-sm-12 col-sm-offset-0">
          <div class="panel panel-default">
            ...
            <div class="panel-body ">
              <?php
              $query=" SELECT * FROM reserva, usuario INNER JOIN couch WHERE (reserva.id_couch= couch.id_couch) AND (reserva.id_usuario= usuario.id_usuario) AND aceptada= '1' AND fecha_aceptada IS NOT NULL";

              $result=mysqli_query($conexion,$query);
              if(mysqli_num_rows($result) == 0){
                ?>
                <div id="alert" role="alert" class="col-md-offset-2 col-md-8 alert alert-info ?>">
               No hubo solicitudes aceptadas.
                </div>
                  <?php
            die();
              }

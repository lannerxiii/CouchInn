...
<body background="<?php echo $bg[array_rand($bg)]; ?>">
	...
	<div class="container" >
		...
		<div class="panel-body" >
			...
			$query="SELECT * FROM reserva INNER JOIN usuario ON (reserva.id_duenoCouch= usuario.id_usuario) WHERE reserva.id_reserva='$idReserva'";
								...
								<div class="panel-body">
									...
									<div class="col-md-offset-0 col-md-6 inf_couch">
										<d1 class="dl-horizontal" >
											...
											<br>
											<form>
														 <input class="btn btn-lg col-md-offset-1" id="botoncitoatras" type="button" value="Volver a mis reservas" onclick="window.location.href='./listado_de_mis_reservas.php'">
										 </form>
										</d1>
